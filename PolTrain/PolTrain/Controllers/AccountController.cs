...
using System.Web;
using Poltrain.Models;
using static PolTrain.ViewModels.AccountViewModel;
...
namespace PolTrain.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.FirstName + " " + model.LastName, Email = model.Email, UserData = new UserData() {FirstName = model.FirstName, LastName = model.LastName, PhoneNumber = model.PhoneNumber} };
